...
impl DeckListClusters {
    ...
    pub fn generate_overlapping_clusters<'a>(deck_id_list: &[&DeckId], similarity_matrix: &'a SimilarityMatrix, threshold: &'a SimilarityScore) -> DeckListClusters {
    ...
    pub fn generate_clusters<'a>(deck_id_list: &[&DeckId], similarity_matrix: &'a SimilarityMatrix, threshold: &'a SimilarityScore) -> DeckListClusters {
        let n = deck_id_list.len();
